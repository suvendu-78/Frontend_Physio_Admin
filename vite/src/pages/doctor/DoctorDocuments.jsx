...
export default function ClinicDocuments() {
  ...
  const [clinicForm, setClinicForm] = useState({
    ...
    ownerDesignation: "Clinic Administrator",
    ownerPhone: "+91 9876543210",
    ownerEmail: "owner@libimotioncare.com",
    registrationNumber: "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const workingHours = Object.entries(workingDays).map(([day, data]) => ({
        day,
        enabled: data.open,
                  ...
                  <div className="border-t border-slate-100 p-5 sm:p-6">
                    <div className="grid gap-5 rounded-2xl bg-slate-50 p-5 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option>Multi-speciality Clinic</option>
                      ...
                      <ClinicInput
                        ...
                        value={clinicForm.ownerDesignation}
                        onChange={(value) =>
                          updateClinicForm("ownerDesignation", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) =>
                          updateClinicForm("ownerEmail", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) =>
                          updateClinicForm("ownerPhone", value)
                        }
                      />
                      ...
                      <ClinicInput
                        icon={MapPin}
                        label="Address Line"
                        value={clinicForm.addressLine}
                        onChange={(value) =>
                          updateClinicForm("addressLine", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) => updateClinicForm("area", value)}
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) => updateClinicForm("website", value)}
                      />
                      ...
                      <ClinicInput
                        ...
                        type="number"
                        value={clinicForm.yearEstablished}
                        onChange={(value) =>
                          updateClinicForm("yearEstablished", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) =>
                          updateClinicForm("latitude", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) =>
                          updateClinicForm("longitude", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        onChange={(value) =>
                          updateClinicForm("registrationNumber", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        value={clinicForm.registrationAuthority}
                        onChange={(value) =>
                          updateClinicForm("registrationAuthority", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        label="Issue Date"
                        type="date"
                        value={clinicForm.issueDate}
                        onChange={(value) =>
                          updateClinicForm("issueDate", value)
                        }
                      />
                      ...
                      <ClinicInput
                        ...
                        label="Expiry Date"
                        type="date"
                        value={clinicForm.expiryDate}
                        onChange={(value) =>
                          updateClinicForm("expiryDate", value)
                        }
                      />
                    </div>
                  </div>
