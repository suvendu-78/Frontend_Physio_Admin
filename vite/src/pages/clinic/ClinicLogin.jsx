...
export default function ClinicLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Clinic login fetching error:", error);
      setLoading(false);
      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        <div className="hidden bg-[#32838c] p-10 text-white lg:flex lg:flex-col lg:justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-bold">LiBi Motion Care</p>

              <p className="text-xs text-white/70">Clinic Partner Portal</p>
            </div>
          </Link>
          ...
          <div className="max-w-lg">
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-white/75">
              Manage doctors, patients, appointments, payments and your clinic
              operations through the LiBi Motion Care partner platform.
            </p>
